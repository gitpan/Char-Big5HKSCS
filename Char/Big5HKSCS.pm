...
Let's start with a bit of history: jperl 4.019+1.3 introduced Big5-HKSCS support.
...
In this country, Big5-HKSCS is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats Big5-HKSCS directly, but doesn't treat
...
Insert 'Char::Ebig5hkscs::' instead of '-' of operator.
  ...
  --------------------------------------------------------------------------
  -r       Char::Ebig5hkscs::r   File is readable by effective uid/gid
  -w       Char::Ebig5hkscs::w   File is writable by effective uid/gid
  -x       Char::Ebig5hkscs::x   File is executable by effective uid/gid
  -o       Char::Ebig5hkscs::o   File is owned by effective uid
  -R       Char::Ebig5hkscs::R   File is readable by real uid/gid
  -W       Char::Ebig5hkscs::W   File is writable by real uid/gid
  -X       Char::Ebig5hkscs::X   File is executable by real uid/gid
  -O       Char::Ebig5hkscs::O   File is owned by real uid
  -e       Char::Ebig5hkscs::e   File exists
  -z       Char::Ebig5hkscs::z   File has zero size
  -f       Char::Ebig5hkscs::f   File is a plain file
  -d       Char::Ebig5hkscs::d   File is a directory
  -l       Char::Ebig5hkscs::l   File is a symbolic link
  -p       Char::Ebig5hkscs::p   File is a named pipe (FIFO)
  -S       Char::Ebig5hkscs::S   File is a socket
  -b       Char::Ebig5hkscs::b   File is a block special file
  -c       Char::Ebig5hkscs::c   File is a character special file
  -t       -t         Filehandle is opened to a tty
  -u       Char::Ebig5hkscs::u   File has setuid bit set
  -g       Char::Ebig5hkscs::g   File has setgid bit set
  -k       Char::Ebig5hkscs::k   File has sticky bit set
  -T       Char::Ebig5hkscs::T   File is a text file
  -B       Char::Ebig5hkscs::B   File is a binary file (opposite of -T)
  -s       Char::Ebig5hkscs::s   File has nonzero size (returns size in bytes)
  -M       Char::Ebig5hkscs::M   Age of file (at startup) in days since modification
  -A       Char::Ebig5hkscs::A   Age of file (at startup) in days since last access
  -C       Char::Ebig5hkscs::C   Age of file (at startup) in days since inode change
  --------------------------------------------------------------------------
