...
my $m_matched   = '';
my $s_matched   = '';
$m_matched   = q{@Char::Ebig5hkscs::m_matched};
...
# chdir
            ...
            my $e_string = 'Char::Ebig5hkscs::chdir';
...
# split
            ...
            my $e_string = 'Char::Ebig5hkscs::split';
...
=item * Handles Raw Big5-HKSCS, No UTF8 flag like JPerl
...
functions.
  ...
  tr///       Char::Ebig5hkscs::tr
  tr///b      tr///
  tr///B      tr///
  y///        Char::Ebig5hkscs::tr
  y///b       tr///
  y///B       tr///
  chop        Char::Ebig5hkscs::chop
  index       Char::Ebig5hkscs::index
  rindex      Char::Ebig5hkscs::rindex
  lc          Char::Ebig5hkscs::lc
  lcfirst     Char::Ebig5hkscs::lcfirst
  uc          Char::Ebig5hkscs::uc
  ucfirst     Char::Ebig5hkscs::ucfirst
  chr         Char::Ebig5hkscs::chr
  glob        Char::Ebig5hkscs::glob
  lstat       Char::Ebig5hkscs::lstat
  opendir     Char::Ebig5hkscs::opendir
  stat        Char::Ebig5hkscs::stat
  unlink      Char::Ebig5hkscs::unlink
  chdir       Char::Ebig5hkscs::chdir
  do          Char::Ebig5hkscs::do
  require     Char::Ebig5hkscs::require
  ---------------------------------
...
=item * Reverse List Or String
  ...
  for (Char::Big5HKSCS::reverse(1 .. 10)) { ... }
  ...
  %barfoo = Char::Big5HKSCS::reverse(%foobar);
...
=item * Special Variables $` And $& Doesn't Function
  ...
  is escaped to
    'AAABBBCCC' =~ /\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?(?:BBB)@Char::Ebig5hkscs::m_matched/;
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. Big5-HKSCS
    +-----------------------------------+
                (No UTF8 Flag)
