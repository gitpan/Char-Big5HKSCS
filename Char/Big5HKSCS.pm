...
=item * Possible to handle raw Big5-HKSCS values

=item * Backward compatibility of data, script and how to

=item * Only Char/Big5HKSCS.pm and Char/Ebig5hkscs.pm, other modules are unnecessary
...
Char/Big5HKSCS.pm remove 'bytes::' at head of function name.
...
Char/Big5HKSCS.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
oriented function. See 'CHARACTER ORIENTED FUNCTIONS'.
  ...
  index       Char::Big5HKSCS::index
  rindex      Char::Big5HKSCS::rindex
  ---------------------------------
