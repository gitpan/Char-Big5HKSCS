...
sub import {
    ...
    if (Char::Ebig5hkscs::e("$filename.e")) {
        if (exists $ENV{'SJIS_DEBUG'}) {
            ...
            my $mtime_filter = (Char::Ebig5hkscs::stat(__FILE__     ))[9];
            my $mtime_source = (Char::Ebig5hkscs::stat($filename    ))[9];
            my $mtime_escape = (Char::Ebig5hkscs::stat("$filename.e"))[9];
...
import of Char/Ebig5hkscs.pm works well.
...
=item * Returns Next Character
  ...
  If you import getc "use Char::Big5HKSCS qw(getc);", getc of your script will be rewritten
  in Char::Big5HKSCS::getc. Char::Big5HKSCS::getc is not compatible with getc of JPerl.
...
=item * Length by Big5-HKSCS Character
  ...
  of the scalar value $string. If $string is omitted, it returns the Char::Big5HKSCS::length
  of $_.
...
=item * Substr by Big5-HKSCS Character
  ...
  If Perl version 5.14 or later, you can use the Char::Big5HKSCS::substr() subroutine as an
...
=item * Rindex by Big5-HKSCS Character
  ...
  This subroutine works just like Char::Big5HKSCS::index except that it returns the character
...
=item * Filename Globbing
  ...
  This operator is implemented via the Char::Ebig5hkscs::glob() subroutine. See Char::Ebig5hkscs::glob
  of Char/Ebig5hkscs.pm for details.
...
=head1 Un-Escaping bytes::* Subroutines (Char/Big5HKSCS.pm provides)

Char/Big5HKSCS.pm removes 'bytes::' at head of subroutine name.
...
If Perl version is older than 5.14, Char::Big5HKSCS::substr differs from CORE::substr, and
...
exist at time of be written this document and JPerl did exist.
                        ...
                        (a)     (b)     (c)     (d)     (e)
                                      JPerl,japerl    Encode,Char::Big5HKSCS
      +--------------+-------+-------+-------+-------+-------+
      | data         |  Old  |  Old  |  New  |  Old  |  New  |
      +--------------+-------+-------+-------+-------+-------+
      | script       |  Old  |      Old      |      New      |
