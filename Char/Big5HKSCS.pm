...
######################################################################
#
# Char::Big5HKSCS - Source code filter to Big5-HKSCS script
#
...
sub Char::Big5HKSCS::escape_script {
    ...
    if (/^ use Char::Ebig5hkscs(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Ebig5hkscs %s;\n%s", $Char::Ebig5hkscs::VERSION, $use_re_eval); # require run-time routines version
...
Char::Big5HKSCS - Source code filter to escape Big5-HKSCS

=head1 SYNOPSIS

  use Char::Big5HKSCS;
  use Char::Big5HKSCS version;         --- require version
...
Regular expression works as character-oriented that has no /b modifier.
  ...
  m?regexp?               m?ditto@Char::Ebig5hkscs::matched?
  s/regexp/replacement/   ($_ =~ m/ditto@Char::Ebig5hkscs::matched/) ?
                          eval{ Char::Ebig5hkscs::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
...
Regular expression works as byte-oriented that has /b modifier.
  ...
  m?regexp?b              m?regexp@Char::Ebig5hkscs::matched?
  s/regexp/replacement/b  ($_ =~ m/(\G[\x00-\xFF]*?)(?:regexp)@Char::Ebig5hkscs::matched/) ?
                          eval{ Char::Ebig5hkscs::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
