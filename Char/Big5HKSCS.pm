...
ended by chr(0x5C), it needs Win32 module. Chdir succeeds when a short path name
can be acquired according to Win32::GetShortPathName(). However, the current
directory is a short path name.
