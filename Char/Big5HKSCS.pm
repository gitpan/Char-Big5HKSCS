...
sub Char::Big5HKSCS::escape_script {
    ...
    if (/^ use Char::Ebig5hkscs(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::Big5HKSCS version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::Big5HKSCS qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::Big5HKSCS ver.sion qw(ord reverse);
  use Char::Big5HKSCS ver.sion.0 qw(ord reverse);
