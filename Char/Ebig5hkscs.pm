...
if (($] >= 5.010001) or
    ...
    if (__PACKAGE__ =~ / \b Egb18030 \z/oxms) {
        ${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[^\x30-\x39\x81-\xFE](?:[\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE]{2})*?}oxms;
    }
...
This module is a run-time routines of the Char/Big5HKSCS.pm.
Because the Char/Big5HKSCS.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Char::Ebig5hkscs::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ebig5hkscs::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Big5-HKSCS $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Ebig5hkscs::fc function for case-insensitive comparisons via Char::Big5HKSCS
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Big5-HKSCS $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Big5-HKSCS $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Big5HKSCS software, this function returns the full Unicode-like casefold of
  Big5-HKSCS $string (or $_, if omitted). This is the internal function implementing
...
=item File test function Char::Ebig5hkscs::X
...
=item Filename expansion (globbing)
  ...
  The Char::Ebig5hkscs::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Char::Ebig5hkscs::stat, Char::Ebig5hkscs::lstat, or Char::Ebig5hkscs::stat-based file test function
