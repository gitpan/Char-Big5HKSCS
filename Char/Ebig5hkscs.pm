...
if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
    if ($ENV{'ComSpec'} =~ / (?: COMMAND\.COM | CMD\.EXE ) \z /oxmsi) {
        ...
        for (@ARGV) {
            ...
            elsif (/\A (?:$q_char)*? [*?] /oxms and (my @glob = Char::Ebig5hkscs::glob($_))) {
                push @argv, @glob;
            }
            else {
                push @argv, $_;
...
#
# Big5-HKSCS fold case lower case without parameter
#
sub Char::Ebig5hkscs::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
=item File test function Char::Ebig5hkscs::X
  ...
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::r(*), Char::Ebig5hkscs::r_()   File is readable by effective uid/gid.
  Char::Ebig5hkscs::w(*), Char::Ebig5hkscs::w_()   File is writable by effective uid/gid.
  Char::Ebig5hkscs::x(*), Char::Ebig5hkscs::x_()   File is executable by effective uid/gid.
  Char::Ebig5hkscs::o(*), Char::Ebig5hkscs::o_()   File is owned by effective uid.
  Char::Ebig5hkscs::R(*), Char::Ebig5hkscs::R_()   File is readable by real uid/gid.
  Char::Ebig5hkscs::W(*), Char::Ebig5hkscs::W_()   File is writable by real uid/gid.
  Char::Ebig5hkscs::X(*), Char::Ebig5hkscs::X_()   File is executable by real uid/gid.
  Char::Ebig5hkscs::O(*), Char::Ebig5hkscs::O_()   File is owned by real uid.
  Char::Ebig5hkscs::e(*), Char::Ebig5hkscs::e_()   File exists.
  Char::Ebig5hkscs::z(*), Char::Ebig5hkscs::z_()   File has zero size.
  Char::Ebig5hkscs::f(*), Char::Ebig5hkscs::f_()   File is a plain file.
  Char::Ebig5hkscs::d(*), Char::Ebig5hkscs::d_()   File is a directory.
  Char::Ebig5hkscs::l(*), Char::Ebig5hkscs::l_()   File is a symbolic link.
  Char::Ebig5hkscs::p(*), Char::Ebig5hkscs::p_()   File is a named pipe (FIFO).
  Char::Ebig5hkscs::S(*), Char::Ebig5hkscs::S_()   File is a socket.
  Char::Ebig5hkscs::b(*), Char::Ebig5hkscs::b_()   File is a block special file.
  Char::Ebig5hkscs::c(*), Char::Ebig5hkscs::c_()   File is a character special file.
  Char::Ebig5hkscs::u(*), Char::Ebig5hkscs::u_()   File has setuid bit set.
  Char::Ebig5hkscs::g(*), Char::Ebig5hkscs::g_()   File has setgid bit set.
  Char::Ebig5hkscs::k(*), Char::Ebig5hkscs::k_()   File has sticky bit set.
  ------------------------------------------------------------------------------
  ...
  Function and Prototype     Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::T(*), Char::Ebig5hkscs::T_()   File is a text file.
  Char::Ebig5hkscs::B(*), Char::Ebig5hkscs::B_()   File is a binary file (opposite of -T).
  ------------------------------------------------------------------------------
  ...
  Function and Prototype     Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::M(*), Char::Ebig5hkscs::M_()   Age of file (at startup) in days since modification.
  Char::Ebig5hkscs::A(*), Char::Ebig5hkscs::A_()   Age of file (at startup) in days since last access.
  Char::Ebig5hkscs::C(*), Char::Ebig5hkscs::C_()   Age of file (at startup) in days since inode change.
  ------------------------------------------------------------------------------
  ...
  Function and Prototype     Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::s(*), Char::Ebig5hkscs::s_()   File has nonzero size (returns size in bytes).
  ------------------------------------------------------------------------------
