...
BEGIN {
    ...
    sub Char::Ebig5hkscs::binmode(*;$);
    sub Char::Ebig5hkscs::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Ebig5hkscs::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Ebig5hkscs::open;
    }
}
...
#
{
    ...
    @Char::Ebig5hkscs::m_matched = (qr/(?{Char::Ebig5hkscs::m_matched})/);
    @Char::Ebig5hkscs::s_matched = (qr/(?{Char::Ebig5hkscs::s_matched})/);
}
...
=item Make character
  ...
  set. For example, Char::Ebig5hkscs::chr(65) is "A" in either ASCII or Big5-HKSCS, and
  Char::Ebig5hkscs::chr(0x82a0) is a Big5-HKSCS HIRAGANA LETTER A. For the reverse of Char::Ebig5hkscs::chr,
  use Char::Big5HKSCS::ord.
...
=item File test operator -X
  ...
  Function and Prototype     Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::s(*), Char::Ebig5hkscs::s_()   File has nonzero size (returns size)
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Ebig5hkscs::binmode(FILEHANDLE, $disciplines);
  Char::Ebig5hkscs::binmode(FILEHANDLE);
  Char::Ebig5hkscs::binmode($filehandle, $disciplines);
  Char::Ebig5hkscs::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Ebig5hkscs::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Ebig5hkscs::open(FILEHANDLE, $expr);
  $rc = Char::Ebig5hkscs::open(FILEHANDLE);
  $rc = Char::Ebig5hkscs::open(my $filehandle, $mode, $expr);
  $rc = Char::Ebig5hkscs::open(my $filehandle, $expr);
  $rc = Char::Ebig5hkscs::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Ebig5hkscs::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Ebig5hkscs::open my $fh, ">logfile" or die ...
  ...
  Char::Ebig5hkscs::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Ebig5hkscs::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Ebig5hkscs::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Ebig5hkscs::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Ebig5hkscs::open(FH, "<:crlf:encoding(Char::Big5HKSCS)", $path) or die "can't open $path: $!";
