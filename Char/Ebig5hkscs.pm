...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Ebig5hkscs::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Ebig5hkscs::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
sub Char::Ebig5hkscs::index($$;$);
sub Char::Ebig5hkscs::rindex($$;$);
sub Char::Ebig5hkscs::lcfirst(@);
sub Char::Ebig5hkscs::lcfirst_();
sub Char::Ebig5hkscs::lc(@);
sub Char::Ebig5hkscs::lc_();
sub Char::Ebig5hkscs::ucfirst(@);
sub Char::Ebig5hkscs::ucfirst_();
sub Char::Ebig5hkscs::uc(@);
...
sub Char::Ebig5hkscs::o(;*@);
sub Char::Ebig5hkscs::R(;*@);
sub Char::Ebig5hkscs::W(;*@);
sub Char::Ebig5hkscs::X(;*@);
sub Char::Ebig5hkscs::O(;*@);
sub Char::Ebig5hkscs::e(;*@);
sub Char::Ebig5hkscs::z(;*@);
sub Char::Ebig5hkscs::s(;*@);
sub Char::Ebig5hkscs::f(;*@);
sub Char::Ebig5hkscs::d(;*@);
sub Char::Ebig5hkscs::l(;*@);
sub Char::Ebig5hkscs::p(;*@);
sub Char::Ebig5hkscs::S(;*@);
sub Char::Ebig5hkscs::b(;*@);
sub Char::Ebig5hkscs::c(;*@);
sub Char::Ebig5hkscs::u(;*@);
sub Char::Ebig5hkscs::g(;*@);
sub Char::Ebig5hkscs::k(;*@);
sub Char::Ebig5hkscs::T(;*@);
sub Char::Ebig5hkscs::B(;*@);
...
sub Char::Ebig5hkscs::o_();
sub Char::Ebig5hkscs::R_();
sub Char::Ebig5hkscs::W_();
sub Char::Ebig5hkscs::X_();
sub Char::Ebig5hkscs::O_();
sub Char::Ebig5hkscs::e_();
sub Char::Ebig5hkscs::z_();
sub Char::Ebig5hkscs::s_();
sub Char::Ebig5hkscs::f_();
sub Char::Ebig5hkscs::d_();
sub Char::Ebig5hkscs::l_();
sub Char::Ebig5hkscs::p_();
sub Char::Ebig5hkscs::S_();
sub Char::Ebig5hkscs::b_();
sub Char::Ebig5hkscs::c_();
sub Char::Ebig5hkscs::u_();
sub Char::Ebig5hkscs::g_();
sub Char::Ebig5hkscs::k_();
sub Char::Ebig5hkscs::T_();
sub Char::Ebig5hkscs::B_();
sub Char::Ebig5hkscs::M_();
sub Char::Ebig5hkscs::A_();
sub Char::Ebig5hkscs::C_();
sub Char::Ebig5hkscs::glob($);
sub Char::Ebig5hkscs::glob_();
sub Char::Ebig5hkscs::lstat(*);
sub Char::Ebig5hkscs::lstat_();
sub Char::Ebig5hkscs::opendir(*$);
sub Char::Ebig5hkscs::stat(*);
sub Char::Ebig5hkscs::stat_();
sub Char::Ebig5hkscs::unlink(@);
sub Char::Ebig5hkscs::chdir(;$);
sub Char::Ebig5hkscs::do($);
sub Char::Ebig5hkscs::require(;$);
sub Char::Ebig5hkscs::telldir(*);
...
sub Char::Big5HKSCS::rindex($$;$);
sub Char::Big5HKSCS::escape(;$);
...
${Char::Ebig5hkscs::anchor}      = qr{\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?}oxms;
BEGIN { CORE::eval q{ use vars qw(
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:$tbcs_1st[^$sbcs]{2})*?}oxms;
    }

    ${Char::Ebig5hkscs::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?|(?(?=[$sbcs]+\z).*?|(?:${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
...
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                                           ))}oxms;

    # avoid: Complex regular subexpression recursion limit (32766) exceeded at here.
    local $^W = 0;

    if (((('A' x 32768).'B') !~ / ${Char::Ebig5hkscs::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Char::Ebig5hkscs::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Char::Ebig5hkscs::anchor} = ${Char::Ebig5hkscs::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
${Char::Ebig5hkscs::dot}         = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x0A])};
${Char::Ebig5hkscs::dot_s}       = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])};
${Char::Ebig5hkscs::eD}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE0-9])};
...
# ${Char::Ebig5hkscs::eS}        = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A    \x0C\x0D\x20])};
# ${Char::Ebig5hkscs::eS}        = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Ebig5hkscs::eS}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s])};

${Char::Ebig5hkscs::eW}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE0-9A-Z_a-z])};
${Char::Ebig5hkscs::eH}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x20])};
${Char::Ebig5hkscs::eV}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x0A\x0B\x0C\x0D])};
${Char::Ebig5hkscs::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Ebig5hkscs::eN}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x0A])};
${Char::Ebig5hkscs::not_alnum}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Ebig5hkscs::not_alpha}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x41-\x5A\x61-\x7A])};
${Char::Ebig5hkscs::not_ascii}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x00-\x7F])};
${Char::Ebig5hkscs::not_blank}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x20])};
${Char::Ebig5hkscs::not_cntrl}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x00-\x1F\x7F])};
${Char::Ebig5hkscs::not_digit}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39])};
${Char::Ebig5hkscs::not_graph}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x21-\x7F])};
${Char::Ebig5hkscs::not_lower}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x61-\x7A])};
${Char::Ebig5hkscs::not_lower_i} = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])};
${Char::Ebig5hkscs::not_print}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x20-\x7F])};
${Char::Ebig5hkscs::not_punct}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Ebig5hkscs::not_space}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s\x0B])};
${Char::Ebig5hkscs::not_upper}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x41-\x5A])};
${Char::Ebig5hkscs::not_upper_i} = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])};
${Char::Ebig5hkscs::not_word}    = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Ebig5hkscs::not_xdigit}  = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39\x41-\x46\x61-\x66])};
${Char::Ebig5hkscs::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Ebig5hkscs::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Ebig5hkscs::foo" used only once: possible typo at here.
${Char::Ebig5hkscs::dot}         = ${Char::Ebig5hkscs::dot};
${Char::Ebig5hkscs::dot_s}       = ${Char::Ebig5hkscs::dot_s};
${Char::Ebig5hkscs::eD}          = ${Char::Ebig5hkscs::eD};
${Char::Ebig5hkscs::eS}          = ${Char::Ebig5hkscs::eS};
${Char::Ebig5hkscs::eW}          = ${Char::Ebig5hkscs::eW};
${Char::Ebig5hkscs::eH}          = ${Char::Ebig5hkscs::eH};
${Char::Ebig5hkscs::eV}          = ${Char::Ebig5hkscs::eV};
${Char::Ebig5hkscs::eR}          = ${Char::Ebig5hkscs::eR};
${Char::Ebig5hkscs::eN}          = ${Char::Ebig5hkscs::eN};
${Char::Ebig5hkscs::not_alnum}   = ${Char::Ebig5hkscs::not_alnum};
${Char::Ebig5hkscs::not_alpha}   = ${Char::Ebig5hkscs::not_alpha};
${Char::Ebig5hkscs::not_ascii}   = ${Char::Ebig5hkscs::not_ascii};
${Char::Ebig5hkscs::not_blank}   = ${Char::Ebig5hkscs::not_blank};
${Char::Ebig5hkscs::not_cntrl}   = ${Char::Ebig5hkscs::not_cntrl};
${Char::Ebig5hkscs::not_digit}   = ${Char::Ebig5hkscs::not_digit};
${Char::Ebig5hkscs::not_graph}   = ${Char::Ebig5hkscs::not_graph};
${Char::Ebig5hkscs::not_lower}   = ${Char::Ebig5hkscs::not_lower};
${Char::Ebig5hkscs::not_lower_i} = ${Char::Ebig5hkscs::not_lower_i};
${Char::Ebig5hkscs::not_print}   = ${Char::Ebig5hkscs::not_print};
${Char::Ebig5hkscs::not_punct}   = ${Char::Ebig5hkscs::not_punct};
${Char::Ebig5hkscs::not_space}   = ${Char::Ebig5hkscs::not_space};
${Char::Ebig5hkscs::not_upper}   = ${Char::Ebig5hkscs::not_upper};
${Char::Ebig5hkscs::not_upper_i} = ${Char::Ebig5hkscs::not_upper_i};
${Char::Ebig5hkscs::not_word}    = ${Char::Ebig5hkscs::not_word};
${Char::Ebig5hkscs::not_xdigit}  = ${Char::Ebig5hkscs::not_xdigit};
${Char::Ebig5hkscs::eb}          = ${Char::Ebig5hkscs::eb};
${Char::Ebig5hkscs::eB}          = ${Char::Ebig5hkscs::eB};
...
sub Char::Ebig5hkscs::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Char::Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
sub Char::Ebig5hkscs::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Ebig5hkscs::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Ebig5hkscs::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Ebig5hkscs::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Ebig5hkscs::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Ebig5hkscs::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Ebig5hkscs::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Ebig5hkscs::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
#
{
    ...
    sub Char::Ebig5hkscs::matched() {
        $last_s_matched = 0;
    }

    # Big5-HKSCS mark last s/// matched
    sub Char::Ebig5hkscs::s_matched() {
        $last_s_matched = 1;
    }
    ...
    $Char::Ebig5hkscs::matched = qr/(?{Char::Ebig5hkscs::matched})/;
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Ebig5hkscs::uc($char[$i]);
                my $fc = Char::Ebig5hkscs::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
sub Char::Ebig5hkscs::classic_character_class {
    ...
    return {
        '\D' => '${Char::Ebig5hkscs::eD}',
        '\S' => '${Char::Ebig5hkscs::eS}',
        '\W' => '${Char::Ebig5hkscs::eW}',
        '\d' => '[0-9]',
        ...
        '\H' => '${Char::Ebig5hkscs::eH}',
        '\V' => '${Char::Ebig5hkscs::eV}',
        '\h' => '[\x09\x20]',
        '\v' => '[\x0A\x0B\x0C\x0D]',
        '\R' => '${Char::Ebig5hkscs::eR}',
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Ebig5hkscs::not_lower_i}',
                '[:^upper:]'  => '${Char::Ebig5hkscs::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Ebig5hkscs::not_alnum}',
                '[:^alpha:]'  => '${Char::Ebig5hkscs::not_alpha}',
                '[:^ascii:]'  => '${Char::Ebig5hkscs::not_ascii}',
                '[:^blank:]'  => '${Char::Ebig5hkscs::not_blank}',
                '[:^cntrl:]'  => '${Char::Ebig5hkscs::not_cntrl}',
                '[:^digit:]'  => '${Char::Ebig5hkscs::not_digit}',
                '[:^graph:]'  => '${Char::Ebig5hkscs::not_graph}',
                '[:^lower:]'  => '${Char::Ebig5hkscs::not_lower}',
                '[:^print:]'  => '${Char::Ebig5hkscs::not_print}',
                '[:^punct:]'  => '${Char::Ebig5hkscs::not_punct}',
                '[:^space:]'  => '${Char::Ebig5hkscs::not_space}',
                '[:^upper:]'  => '${Char::Ebig5hkscs::not_upper}',
                '[:^word:]'   => '${Char::Ebig5hkscs::not_word}',
                '[:^xdigit:]' => '${Char::Ebig5hkscs::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Ebig5hkscs::uc($char);
                        my $fc = Char::Ebig5hkscs::fc($char);
                        if ($uc eq $fc) {
...
sub Char::Ebig5hkscs::filetest {
    ...
    unless (CORE::eval qq{Char::Ebig5hkscs::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Ebig5hkscs::r(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -r (Char::Ebig5hkscs::r)' if @_ and not wantarray;
    ...
    # (and so on)
        ...
        if (-d "$_/.") {
            ...
            # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ebig5hkscs::*()
...
sub Char::Ebig5hkscs::w(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -w (Char::Ebig5hkscs::w)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::x(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -x (Char::Ebig5hkscs::x)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::o(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -o (Char::Ebig5hkscs::o)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::e(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -e (Char::Ebig5hkscs::e)' if @_ and not wantarray;
    ...
    elsif (defined Char::Ebig5hkscs::telldir($fh)) {
        return wantarray ? ('',@_) : '';
    }
...
sub Char::Ebig5hkscs::z(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -z (Char::Ebig5hkscs::z)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::s(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -s (Char::Ebig5hkscs::s)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::f(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -f (Char::Ebig5hkscs::f)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::d(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -d (Char::Ebig5hkscs::d)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::l(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -l (Char::Ebig5hkscs::l)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::p(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -p (Char::Ebig5hkscs::p)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::b(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -b (Char::Ebig5hkscs::b)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::c(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -c (Char::Ebig5hkscs::c)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::u(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -u (Char::Ebig5hkscs::u)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::g(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -g (Char::Ebig5hkscs::g)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::k(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -k (Char::Ebig5hkscs::k)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::T(;*@) {
    ...
    #     croak 'Too many arguments for -T (Char::Ebig5hkscs::T)';
    ...
    if (defined fileno $fh) {
        ...
        if (defined Char::Ebig5hkscs::telldir($fh)) {
            return wantarray ? (undef,@_) : undef;
        }
...
sub Char::Ebig5hkscs::M(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -M (Char::Ebig5hkscs::M)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::A(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -A (Char::Ebig5hkscs::A)' if @_ and not wantarray;
...
sub Char::Ebig5hkscs::filetest_ {
    ...
    unless (CORE::eval qq{Char::Ebig5hkscs::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
OUTER:
    for my $expr (@expr) {
        ...
        if ($expr =~ /\A " ((?:$q_char)*) " \z/oxms) {
            $expr = $1;
            if ($cond eq 'd') {
                if (Char::Ebig5hkscs::d $expr) {
                    push @glob, $expr;
                }
            }
            else {
                if (Char::Ebig5hkscs::e $expr) {
                    push @glob, $expr;
                }
            }
            next OUTER;
        ...
        if ($expr !~ / \A (?:$q_char)*? [*?] /oxms) {
            ...
            $head .= $expr;
            if ($cond eq 'd') {
                if (Char::Ebig5hkscs::d $head) {
                    push @glob, $head;
                }
            }
            else {
                if (Char::Ebig5hkscs::e $head) {
                    push @glob, $head;
                }
            }
            next OUTER;
        }
        Char::Ebig5hkscs::opendir(*DIR, $head) or next OUTER;
        my @leaf = readdir DIR;
        closedir DIR;
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Ebig5hkscs::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Ebig5hkscs::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if ($cond eq 'd' and not Char::Ebig5hkscs::d "$head$leaf") {
                next INNER;
            }
            ...
            if (Char::Ebig5hkscs::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Ebig5hkscs::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub my_home {
    ...
    if (defined $home and ! Char::Ebig5hkscs::d($home)) {
        $home = undef;
    }
    return $home;
}
...
sub Char::Ebig5hkscs::lstat(*) {
    ...
    if (-e $_) {
        ...
        # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ebig5hkscs::lstat()
        # on Windows opens the file for the path which has 5c at end.
        # (and so on)
...
sub Char::Ebig5hkscs::stat(*) {
    ...
    if (defined fileno $fh) {
        ...
        # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ebig5hkscs::stat()
        # on Windows opens the file for the path which has 5c at end.
        # (and so on)
        ...
        # rejected idea ...
            ...
            if (($] =~ /^5\.006/oxms)                     and
                ...
                *{'Dyna'.'Loader::dl_install_xsub'}{'CODE'}->('_SetCurrentDirectoryA', unpack('L', pack 'P', $x86));
                ...
                if (Char::Ebig5hkscs::fc($chdir) eq Char::Ebig5hkscs::fc($dir)) {
                    return 1;
                }
                else {
                    return 0;
...
#   long filename form.
        ...
        if (qx{ver} =~ /\b(?:Windows NT|Windows 2000)\b/oms) {
            ...
            for my $dirx (sort { CORE::length($a) <=> CORE::length($b) } @dirx) {
                if (Char::Ebig5hkscs::fc(CORE::substr $dirx,-CORE::length($subdir[-1]),CORE::length($subdir[-1])) eq Char::Ebig5hkscs::fc($subdir[-1])) {
        ...
        elsif (Char::Ebig5hkscs::fc($shortdir) eq Char::Ebig5hkscs::fc($dir)) {
            return 0;
        }
        return CORE::chdir $shortdir;
    }
...
ITER_DO:
    {
        for my $prefix (@INC) {
            ...
            if (Char::Ebig5hkscs::f($realfilename)) {

                my $script = '';

                if (Char::Ebig5hkscs::e("$realfilename.e")) {
                    my $e_mtime      = (Char::Ebig5hkscs::stat("$realfilename.e"))[9];
                    my $mtime        = (Char::Ebig5hkscs::stat($realfilename))[9];
                    my $module_mtime = (Char::Ebig5hkscs::stat(__FILE__))[9];
                    if (($e_mtime < $mtime) or ($mtime < $module_mtime)) {
                        Char::Ebig5hkscs::unlink "$realfilename.e";
                    }
                }
                ...
                if (Char::Ebig5hkscs::e("$realfilename.e")) {
                    ...
                    if ($script =~ /^ \s* use \s+ Char::Big5HKSCS \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                        CORE::require Char::Big5HKSCS;
                        $script = Char::Big5HKSCS::escape_script($script);
                        my $fh = gensym();
...
sub Char::Big5HKSCS::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Ebig5hkscs::index($_[0], $_[1], CORE::length(Char::Big5HKSCS::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Ebig5hkscs::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Big5HKSCS::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::Big5HKSCS::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Ebig5hkscs::rindex($_[0], $_[1], CORE::length(Char::Big5HKSCS::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Ebig5hkscs::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Big5HKSCS::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $anchor = '';
$anchor = q{${Char::Ebig5hkscs::anchor}};
...
my $qq_substr  = qr{(?: Char::Big5HKSCS::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
my $matched     = '';
my $s_matched   = '';
$matched        = q{$Char::Ebig5hkscs::matched};
$s_matched      = q{ Char::Ebig5hkscs::s_matched();};
...
sub Char::Big5HKSCS::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Big5HKSCS::escape_token();
    }
...
#
sub Char::Big5HKSCS::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ebig5hkscs::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ebig5hkscs::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ebig5hkscs::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ebig5hkscs::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ebig5hkscs::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ebig5hkscs::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Ebig5hkscs::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Ebig5hkscs::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Ebig5hkscs::glob';
    }
...
# subroutines of package Char::Ebig5hkscs
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Big5HKSCS::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Big5HKSCS::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Big5HKSCS::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Big5HKSCS::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Big5HKSCS::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Big5HKSCS::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Big5HKSCS::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::fc';         }
    ...
    # (and so on)
                                                         ...
                                                         \s* (\") ((?:$qq_char)+?)             (\") /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                         \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1),$2)"; }
    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1),$2)"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest qw($1),";    }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest(qw($1),$2)"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Ebig5hkscs::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1";                 }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::$1(::"."$2)";        }
    elsif (/\G -(t)                            \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "-t $2";                     }
    elsif (/\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::lstat';              }
    elsif (/\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::stat';               }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::fc_';               }
    elsif (/\G \b lstat \b         (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::lstat_';            }
    elsif (/\G \b stat \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::stat_';             }
    elsif (/\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                     \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::filetest_(qw($1))"; }
    elsif (/\G    -([rwxoRWXOezsfdlpSbcugkTBMAC])
                     \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::${1}_";             }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::glob_';             }
    elsif (/\G \b reverse \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_reverse;          }
    elsif (/\G \b getc \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_getc;             }
    elsif (/\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::opendir$1*";        }
    elsif (/\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Ebig5hkscs::opendir$1*";        }
    elsif (/\G \b unlink \b        (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ebig5hkscs::unlink';            }

# chdir
    elsif (/\G \b (chdir) \b       (?! \s* => ) /oxgc) {
        $slash = 'm//';

        my $e = 'Char::Ebig5hkscs::chdir';
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ebig5hkscs::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Ebig5hkscs::split' . $e . qq     {" "};  }
...
# do
    ...
    elsif (/\G \b do (?= \s+ (?: q | qq | qx ) \b)                                    /oxmsgc) { return 'Char::Ebig5hkscs::do';         }
    elsif (/\G \b do (?= \s+ \w+)                                                     /oxmsgc) { return 'do';                }
    elsif (/\G \b do (?= \s* \$ \w+ (?: ::\w+)* \( )                                  /oxmsgc) { return 'do';                }
    elsif (/\G \b do \b                                                               /oxmsgc) { return 'Char::Ebig5hkscs::do';         }
...
# require else
    elsif (/\G \b require                                   \s* ;                     /oxmsgc) { return 'Char::Ebig5hkscs::require;';   }
    elsif (/\G \b require \b                                                          /oxmsgc) { return 'Char::Ebig5hkscs::require';    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Ebig5hkscs::PREMATCH()]}
            ...
            $e_string .= q{Char::Ebig5hkscs::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Ebig5hkscs::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Ebig5hkscs::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Ebig5hkscs::POSTMATCH()]}
            ...
            $e_string .= q{Char::Ebig5hkscs::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Ebig5hkscs
        ...
        elsif ($string =~ /\G \b Char::Big5HKSCS::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Big5HKSCS::eval \b                                /oxgc) { $e_string .= 'eval Char::Big5HKSCS::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Ebig5hkscs::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Big5HKSCS::index \b                               /oxgc) { $e_string .= 'Char::Big5HKSCS::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Ebig5hkscs::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Big5HKSCS::rindex \b                              /oxgc) { $e_string .= 'Char::Big5HKSCS::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Ebig5hkscs::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::fc';         $slash = 'm//'; }
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\") ((?:$qq_char)+?)             (\") /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Ebig5hkscs::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest qw($1),";    $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest(qw($1),$2)"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Ebig5hkscs::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $e_string .= "Char::Ebig5hkscs::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $e_string .= "Char::Ebig5hkscs::$1";          $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $e_string .= "Char::Ebig5hkscs::$1(::"."$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G -(t)                            \s+ (\w+)                                            /oxgc) { $e_string .= "-t $2";              $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Ebig5hkscs::lstat';       $slash = 'm//'; }
        elsif ($string =~ /\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Ebig5hkscs::stat';        $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Ebig5hkscs::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Ebig5hkscs::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Ebig5hkscs::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Ebig5hkscs::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Ebig5hkscs::fc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat \b                                           /oxgc) { $e_string .= 'Char::Ebig5hkscs::lstat_';            $slash = 'm//'; }
        elsif ($string =~ /\G \b stat \b                                            /oxgc) { $e_string .= 'Char::Ebig5hkscs::stat_';             $slash = 'm//'; }
        elsif ($string =~ /\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                 \b                 /oxgc) { $e_string .= "Char::Ebig5hkscs::filetest_(qw($1))"; $slash = 'm//'; }
        elsif ($string =~ /\G    -([rwxoRWXOezsfdlpSbcugkTBMAC]) \b                 /oxgc) { $e_string .= "Char::Ebig5hkscs::${1}_";             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Ebig5hkscs::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Ebig5hkscs::glob_';             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Ebig5hkscs::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Ebig5hkscs::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b unlink \b                                          /oxgc) { $e_string .= 'Char::Ebig5hkscs::unlink';            $slash = 'm//'; }

# chdir
        elsif ($string =~ /\G \b (chdir) \b (?! \s* => ) /oxgc) {
            $slash = 'm//';

            $e_string .= 'Char::Ebig5hkscs::chdir';
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ebig5hkscs::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Ebig5hkscs::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
# <WILDCARD>   --- glob
            ...
            $e_string .= 'Char::Ebig5hkscs::glob("' . $1 . '")';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Ebig5hkscs::dot_s}';
        }
        else {
            return '${Char::Ebig5hkscs::dot}';
        }
    }
    else {
        return Char::Ebig5hkscs::classic_character_class($char);
    }
}
...
sub e_capture {
    ...
    return join '', '${Char::Ebig5hkscs::capture(', $_[0], ')}';
    return join '', '${',                $_[0],  '}';
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Ebig5hkscs::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Ebig5hkscs::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Ebig5hkscs::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Ebig5hkscs::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Ebig5hkscs::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Ebig5hkscs::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Ebig5hkscs::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Ebig5hkscs::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Ebig5hkscs::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ebig5hkscs::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ebig5hkscs::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ebig5hkscs::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ebig5hkscs::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Ebig5hkscs::uc($char[$i]) ne Char::Ebig5hkscs::fc($char[$i]))) {
            if (CORE::length(Char::Ebig5hkscs::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Ebig5hkscs::uc($char[$i])       . Char::Ebig5hkscs::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Ebig5hkscs::uc($char[$i]) . '|' . Char::Ebig5hkscs::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5hkscs::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ebig5hkscs::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5hkscs::ignorecase(Char::Ebig5hkscs::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ebig5hkscs::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ebig5hkscs::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5hkscs::ignorecase(Char::Ebig5hkscs::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ebig5hkscs::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ebig5hkscs::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5hkscs::ignorecase(Char::Ebig5hkscs::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ebig5hkscs::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::Big5HKSCS::re_t=%s; local $Char::Big5HKSCS::re_a=''; while($Char::Big5HKSCS::re_t =~ %s){%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s$Char::Big5HKSCS::re_t="$Char::Big5HKSCS::re_a${1}$Char::Big5HKSCS::re_r$'"; pos($Char::Big5HKSCS::re_t)=length "$Char::Big5HKSCS::re_a${1}$Char::Big5HKSCS::re_r"; $Char::Big5HKSCS::re_a=substr($Char::Big5HKSCS::re_t,0,pos($Char::Big5HKSCS::re_t)); } return $Char::Big5HKSCS::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Big5HKSCS::re_r=CORE::eval $Char::Big5HKSCS::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Big5HKSCS::re_t=%s; while($Char::Big5HKSCS::re_t =~ %s){%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s$Char::Big5HKSCS::re_t="$`$Char::Big5HKSCS::re_r$'"; pos($Char::Big5HKSCS::re_t)=length "$`$Char::Big5HKSCS::re_r"; } return $Char::Big5HKSCS::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s"%s$Char::Big5HKSCS::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::Big5HKSCS::re_n=0; local $Char::Big5HKSCS::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s%s="$Char::Big5HKSCS::re_a${1}$Char::Big5HKSCS::re_r$'"; pos(%s)=length "$Char::Big5HKSCS::re_a${1}$Char::Big5HKSCS::re_r"; $Char::Big5HKSCS::re_a=substr(%s,0,pos(%s)); $Char::Big5HKSCS::re_n++} return %s$Char::Big5HKSCS::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Big5HKSCS::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s%s="$`$Char::Big5HKSCS::re_r$'"; pos(%s)=length "$`$Char::Big5HKSCS::re_r"; $Char::Big5HKSCS::re_n++} return %s$Char::Big5HKSCS::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s%s="%s$Char::Big5HKSCS::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Big5HKSCS::re_r=%s; %s%s="%s$Char::Big5HKSCS::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Big5HKSCS::re_r=CORE::eval $Char::Big5HKSCS::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_chdir {
    ...
    if ($^W) {
        if (Char::Ebig5hkscs::_MSWin32_5Cended_path($string)) {
            if ($] !~ /^5\.005/) {
                warn <<END;
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ebig5hkscs::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Ebig5hkscs::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Ebig5hkscs::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
sub e_use_noimport {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ebig5hkscs::_open_r($fh, $realfilename)) {
            local $/ = undef; # slurp mode
            my $script = <$fh>;
            close($fh) or die __FILE__, ": Can't close file: $realfilename";

            if ($script =~ /^ \s* use \s+ Char::Big5HKSCS \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq<BEGIN { Char::Ebig5hkscs::require '$expr'; }>;
            }
            last;
        }
    }
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ebig5hkscs::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::Big5HKSCS \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                ...
                return qq[BEGIN { Char::Ebig5hkscs::require '$expr'; $module->import() if $module->can('import'); }];
            }
            last;
        }
    }
...
sub e_no_noparam {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ebig5hkscs::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::Big5HKSCS \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Ebig5hkscs::require '$expr'; $module->unimport() if $module->can('unimport'); }];
            }
            last;
        }
    }
...
sub e_use {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ebig5hkscs::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::Big5HKSCS \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Ebig5hkscs::require '$expr'; $module->import($list) if $module->can('import'); }];
            }
            last;
        }
    }
...
sub e_no {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ebig5hkscs::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::Big5HKSCS \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Ebig5hkscs::require '$expr'; $module->unimport($list) if $module->can('unimport'); }];
            }
            last;
        }
    }
...
=head1 SYNOPSIS
  ...
  use Char::Ebig5hkscs;
    ...
    Char::Ebig5hkscs::split(...);
    Char::Ebig5hkscs::tr(...);
    Char::Ebig5hkscs::chop(...);
    Char::Ebig5hkscs::index(...);
    Char::Ebig5hkscs::rindex(...);
    Char::Ebig5hkscs::lc(...);
    Char::Ebig5hkscs::lc_;
    Char::Ebig5hkscs::lcfirst(...);
    Char::Ebig5hkscs::lcfirst_;
    Char::Ebig5hkscs::uc(...);
    Char::Ebig5hkscs::uc_;
    Char::Ebig5hkscs::ucfirst(...);
    Char::Ebig5hkscs::ucfirst_;
    Char::Ebig5hkscs::fc(...);
    Char::Ebig5hkscs::fc_;
    Char::Ebig5hkscs::ignorecase(...);
    Char::Ebig5hkscs::capture(...);
    Char::Ebig5hkscs::chr(...);
    Char::Ebig5hkscs::chr_;
    Char::Ebig5hkscs::X ...;
    Char::Ebig5hkscs::X_;
    Char::Ebig5hkscs::glob(...);
    Char::Ebig5hkscs::glob_;
    Char::Ebig5hkscs::lstat(...);
    Char::Ebig5hkscs::lstat_;
    Char::Ebig5hkscs::opendir(...);
    Char::Ebig5hkscs::stat(...);
    Char::Ebig5hkscs::stat_;
    Char::Ebig5hkscs::unlink(...);
    Char::Ebig5hkscs::chdir(...);
    Char::Ebig5hkscs::do(...);
    Char::Ebig5hkscs::require(...);
    Char::Ebig5hkscs::telldir(...);

  # "no Char::Ebig5hkscs;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Big5HKSCS software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Big5HKSCS software and not
...
This Char::Ebig5hkscs module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Ebig5hkscs::split(/pattern/,$string,$limit);
  @split = Char::Ebig5hkscs::split(/pattern/,$string);
  @split = Char::Ebig5hkscs::split(/pattern/);
  @split = Char::Ebig5hkscs::split('',$string,$limit);
  @split = Char::Ebig5hkscs::split('',$string);
  @split = Char::Ebig5hkscs::split('');
  @split = Char::Ebig5hkscs::split();
  @split = Char::Ebig5hkscs::split;
  ...
  at all, Char::Ebig5hkscs::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Ebig5hkscs::split(//,  $word);
  @fields = Char::Ebig5hkscs::split(/:/, $line);
  @words  = Char::Ebig5hkscs::split(" ", $paragraph);
  @lines  = Char::Ebig5hkscs::split(/^/, $buffer);
  ...
  print join(":" => Char::Ebig5hkscs::split(/ */, "hi there"));
  ...
  Char::Ebig5hkscs::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Ebig5hkscs::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Ebig5hkscs::split with no arguments does. Thus,
  Char::Ebig5hkscs::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Ebig5hkscs::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Ebig5hkscs::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Ebig5hkscs::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Ebig5hkscs::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Ebig5hkscs::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Ebig5hkscs::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Ebig5hkscs::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Ebig5hkscs::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Ebig5hkscs::chop(@list);
  $chop = Char::Ebig5hkscs::chop();
  $chop = Char::Ebig5hkscs::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Ebig5hkscs::chop subroutine is used primary to remove the newline
  ...
  since Char::Ebig5hkscs::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Ebig5hkscs::chop a literal, only a variable. If you Char::Ebig5hkscs::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Ebig5hkscs::chop(@lines);

  You can Char::Ebig5hkscs::chop anything that is an lvalue, including an assignment:

  Char::Ebig5hkscs::chop($cwd = `pwd`);
  Char::Ebig5hkscs::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Ebig5hkscs::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Ebig5hkscs::chop returns the character
  ...
  In the most general case, Char::Ebig5hkscs::chop can be expressed using substr:

  $last_code = Char::Ebig5hkscs::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Ebig5hkscs::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Ebig5hkscs::chop;
...
=item Index string
  ...
  $byte_pos = Char::Ebig5hkscs::index($string,$substr,$byte_offset);
  $byte_pos = Char::Ebig5hkscs::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Ebig5hkscs::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Ebig5hkscs::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Ebig5hkscs::rindex($string,$substr);

  This subroutine works just like Char::Ebig5hkscs::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Ebig5hkscs::index).
  ...
  while (($byte_pos = Char::Big5HKSCS::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Ebig5hkscs::lc($string);
  $lc = Char::Ebig5hkscs::lc_;
  ...
  You can use the Char::Ebig5hkscs::fc subroutine for case-insensitive comparisons via Char::Big5HKSCS
  software.

=item Lower case first character of string

  $lcfirst = Char::Ebig5hkscs::lcfirst($string);
  $lcfirst = Char::Ebig5hkscs::lcfirst_;
...
=item Upper case string
  ...
  $uc = Char::Ebig5hkscs::uc($string);
  $uc = Char::Ebig5hkscs::uc_;
  ...
  in interpolated strings. For titlecase, use Char::Ebig5hkscs::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Ebig5hkscs::ucfirst($string);
  $ucfirst = Char::Ebig5hkscs::ucfirst_;
  ...
  $titlecase = Char::Ebig5hkscs::ucfirst(substr($word,0,1)) . Char::Ebig5hkscs::lc(substr($word,1));
  ...
  $do_not_use = Char::Ebig5hkscs::ucfirst(Char::Ebig5hkscs::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Ebig5hkscs::fc($string);
  $fc = Char::Ebig5hkscs::fc_;

  New to Char::Big5HKSCS software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Ebig5hkscs::fc($a) eq Char::Ebig5hkscs::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Big5HKSCS software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Ebig5hkscs::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Ebig5hkscs::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Ebig5hkscs::chr($code);
  $chr = Char::Ebig5hkscs::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Ebig5hkscs::chr(65) is "A" in either
  ASCII or Big5-HKSCS, not Unicode. For the reverse of Char::Ebig5hkscs::chr, use Char::Big5HKSCS::ord.

=item File test subroutine Char::Ebig5hkscs::X
  ...
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::r(*), Char::Ebig5hkscs::r_()   File or directory is readable by this (effective) user or group
  Char::Ebig5hkscs::w(*), Char::Ebig5hkscs::w_()   File or directory is writable by this (effective) user or group
  Char::Ebig5hkscs::e(*), Char::Ebig5hkscs::e_()   File or directory name exists
  Char::Ebig5hkscs::x(*), Char::Ebig5hkscs::x_()   File or directory is executable by this (effective) user or group
  Char::Ebig5hkscs::z(*), Char::Ebig5hkscs::z_()   File exists and has zero size (always false for directories)
  Char::Ebig5hkscs::f(*), Char::Ebig5hkscs::f_()   Entry is a plain file
  Char::Ebig5hkscs::d(*), Char::Ebig5hkscs::d_()   Entry is a directory
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::R(*), Char::Ebig5hkscs::R_()   File or directory is readable by this real user or group
                             Same as Char::Ebig5hkscs::r(*), Char::Ebig5hkscs::r_() on MacOS
  Char::Ebig5hkscs::W(*), Char::Ebig5hkscs::W_()   File or directory is writable by this real user or group
                             Same as Char::Ebig5hkscs::w(*), Char::Ebig5hkscs::w_() on MacOS
  Char::Ebig5hkscs::X(*), Char::Ebig5hkscs::X_()   File or directory is executable by this real user or group
                             Same as Char::Ebig5hkscs::x(*), Char::Ebig5hkscs::x_() on MacOS
  Char::Ebig5hkscs::l(*), Char::Ebig5hkscs::l_()   Entry is a symbolic link
  Char::Ebig5hkscs::S(*), Char::Ebig5hkscs::S_()   Entry is a socket
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::o(*), Char::Ebig5hkscs::o_()   File or directory is owned by this (effective) user
  Char::Ebig5hkscs::O(*), Char::Ebig5hkscs::O_()   File or directory is owned by this real user
  Char::Ebig5hkscs::p(*), Char::Ebig5hkscs::p_()   Entry is a named pipe (a "fifo")
  Char::Ebig5hkscs::b(*), Char::Ebig5hkscs::b_()   Entry is a block-special file (like a mountable disk)
  Char::Ebig5hkscs::c(*), Char::Ebig5hkscs::c_()   Entry is a character-special file (like an I/O device)
  Char::Ebig5hkscs::u(*), Char::Ebig5hkscs::u_()   File or directory is setuid
  Char::Ebig5hkscs::g(*), Char::Ebig5hkscs::g_()   File or directory is setgid
  Char::Ebig5hkscs::k(*), Char::Ebig5hkscs::k_()   File or directory has the sticky bit set
  ------------------------------------------------------------------------------
  ...
  The Char::Ebig5hkscs::T, Char::Ebig5hkscs::T_, Char::Ebig5hkscs::B, and Char::Ebig5hkscs::B_ work as follows. The first block
  ...
  \377 in the first block is considered a binary file. If Char::Ebig5hkscs::T or Char::Ebig5hkscs::B is
  used on a filehandle, the current input (standard I/O or "stdio") buffer is
  examined rather than the first block of the file. Both Char::Ebig5hkscs::T and Char::Ebig5hkscs::B
  return 1 as true on an empty file, or on a file at EOF (end-of-file) when testing
  a filehandle. Both Char::Ebig5hkscs::T and Char::Ebig5hkscs::B doesn't work when given the special
  filehandle consisting of a solitary underline. Because Char::Ebig5hkscs::T has to read to
  do the test, you don't want to use Char::Ebig5hkscs::T on special files that might hang or
  give you other kinds or grief. So on most occasions you'll want to test with a
  Char::Ebig5hkscs::f first, as in:

  next unless Char::Ebig5hkscs::f($file) && Char::Ebig5hkscs::T($file);

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::T(*), Char::Ebig5hkscs::T_()   File looks like a "text" file
  Char::Ebig5hkscs::B(*), Char::Ebig5hkscs::B_()   File looks like a "binary" file
  ------------------------------------------------------------------------------

  File ages for Char::Ebig5hkscs::M, Char::Ebig5hkscs::M_, Char::Ebig5hkscs::A, Char::Ebig5hkscs::A_, Char::Ebig5hkscs::C, and Char::Ebig5hkscs::C_
  ...
  next unless Char::Ebig5hkscs::M($file) > 0.5;     # files are older than 12 hours
  &newfile if Char::Ebig5hkscs::M($file) < 0;       # file is newer than process
  &mailwarning if int(Char::Ebig5hkscs::A_) == 90;  # file ($_) was accessed 90 days ago today

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::M(*), Char::Ebig5hkscs::M_()   Modification age (measured in days)
  Char::Ebig5hkscs::A(*), Char::Ebig5hkscs::A_()   Access age (measured in days)
                             Same as Char::Ebig5hkscs::M(*), Char::Ebig5hkscs::M_() on MacOS
  Char::Ebig5hkscs::C(*), Char::Ebig5hkscs::C_()   Inode-modification age (measured in days)
  ------------------------------------------------------------------------------

  The Char::Ebig5hkscs::s, and Char::Ebig5hkscs::s_ returns file size in bytes if succesful, or undef
  unless successful.
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ebig5hkscs::s(*), Char::Ebig5hkscs::s_()   File or directory exists and has nonzero size
                             (the value is the size in bytes)
  ------------------------------------------------------------------------------

=item Filename expansion (globbing)

  @glob = Char::Ebig5hkscs::glob($string);
  @glob = Char::Ebig5hkscs::glob_;
  ...
  The Char::Ebig5hkscs::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Ebig5hkscs::glob('"*e f*"');
  @spacies = Char::Ebig5hkscs::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Ebig5hkscs::glob("'*${var}e f*'");
  @spacies = Char::Ebig5hkscs::glob(qq("*${var}e f*"));
...
=item Statistics about link
  ...
  @lstat = Char::Ebig5hkscs::lstat($file);
  @lstat = Char::Ebig5hkscs::lstat_;

  Like Char::Ebig5hkscs::stat, returns information on file, except that if file is a symbolic
  link, Char::Ebig5hkscs::lstat returns information about the link; Char::Ebig5hkscs::stat returns
  information about the file pointed to by the link. If symbolic links are
  unimplemented on your system, a normal Char::Ebig5hkscs::stat is done instead. If file is
...
=item Open directory handle
  ...
  $rc = Char::Ebig5hkscs::opendir(DIR,$dir);
...
=item Statistics about file
  ...
  $stat = Char::Ebig5hkscs::stat(FILEHANDLE);
  $stat = Char::Ebig5hkscs::stat(DIRHANDLE);
  $stat = Char::Ebig5hkscs::stat($expr);
  $stat = Char::Ebig5hkscs::stat_;
  @stat = Char::Ebig5hkscs::stat(FILEHANDLE);
  @stat = Char::Ebig5hkscs::stat(DIRHANDLE);
  @stat = Char::Ebig5hkscs::stat($expr);
  @stat = Char::Ebig5hkscs::stat_;
  ...
  ($dev,$ino,$mode,$nlink,$uid,$gid,$rdev,$size,
      $atime,$mtime,$ctime,$blksize,$blocks) = Char::Ebig5hkscs::stat($expr);
  ...
  If Char::Ebig5hkscs::stat is passed the special filehandle consisting of an underline, no
  actual stat(2) is done, but the current contents of the stat structure from
  the last Char::Ebig5hkscs::stat, Char::Ebig5hkscs::lstat, or Char::Ebig5hkscs::stat-based file test subroutine
  (such as Char::Ebig5hkscs::r, Char::Ebig5hkscs::w, and Char::Ebig5hkscs::x) are returned.
  ...
  $mode = (Char::Ebig5hkscs::stat($expr))[2];
...
=item Deletes a list of files.
  ...
  $unlink = Char::Ebig5hkscs::unlink(@list);
  $unlink = Char::Ebig5hkscs::unlink($file);
  $unlink = Char::Ebig5hkscs::unlink;
...
=item Changes the working directory.
  ...
  $chdir = Char::Ebig5hkscs::chdir($dirname);
  $chdir = Char::Ebig5hkscs::chdir;
...
=item Do file
  ...
  $return = Char::Ebig5hkscs::do($file);
  ...
  Char::Ebig5hkscs::do('stat.pl');

  is rather like: 

  scalar CORE::eval `cat stat.pl`;   # `type stat.pl` on Windows

  except that Char::Ebig5hkscs::do is more efficient, more concise, keeps track of the current
  filename for error messages, searches all the directories listed in the @INC
  array, and updates %INC if the file is found.
  It also differs in that code evaluated with Char::Ebig5hkscs::do FILE can not see lexicals in
  ...
  If Char::Ebig5hkscs::do can't read the file, it returns undef and sets $! to the error. If 
  Char::Ebig5hkscs::do can read the file but can't compile it, it returns undef and sets an
  ...
  with the use and require operators, which also Char::Ebig5hkscs::do error checking and raise
  ...
  But Char::Ebig5hkscs::do FILE is still useful for such things as reading program configuration
  files. Manual error checking can be done this way:

  # read in config files: system first, then user
  for $file ("/usr/share/proggie/defaults.rc", "$ENV{HOME}/.someprogrc") {
      unless ($return = Char::Ebig5hkscs::do($file)) {
          warn "couldn't parse $file: $@" if $@;
          warn "couldn't Char::Ebig5hkscs::do($file): $!" unless defined $return;
  ...
  Char::Ebig5hkscs::do to reload that file. This is more tidily accomplished with Char::Ebig5hkscs::do than
  with Char::Ebig5hkscs::require.

=item Require file

  Char::Ebig5hkscs::require($file);
  Char::Ebig5hkscs::require();

  This subroutine asserts a dependency of some kind on its argument. If an argument is
  not supplied, $_ is used.

  Char::Ebig5hkscs::require loads and executes the Perl code found in the separate file whose
  name is given by the $file. This is similar to using a Char::Ebig5hkscs::do on a file, except
  that Char::Ebig5hkscs::require checks to see whether the library file has been loaded already
  ...
  its cousins Char::Ebig5hkscs::do, Char::Ebig5hkscs::require knows how to search the include path stored
...
=item Current position of the readdir
  ...
  $telldir = Char::Ebig5hkscs::telldir(DIRHANDLE);
