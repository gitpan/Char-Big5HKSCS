...
This module is a run-time routines of the Char::Big5HKSCS module.
Because the Char::Big5HKSCS module automatically uses this module, you need not use directly.
...
=item current position of the readdir
  ...
  Char::Ebig5hkscs::telldir(DIRHANDLE);
