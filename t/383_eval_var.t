...
# eval $var has eval "..."
$var = <<'END';
eval Char::Big5HKSCS::escape " if ('アソ' !~ /A/) { return 1 } else { return 0 } "
END
if (eval Char::Big5HKSCS::escape $var) {
...
$var = <<'END';
eval Char::Big5HKSCS::escape qq{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
if (eval Char::Big5HKSCS::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Char::Big5HKSCS::escape ' if (qq{アソ} !~ /A/) { return 1 } else { return 0 } '
END
if (eval Char::Big5HKSCS::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Char::Big5HKSCS::escape q{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
if (eval Char::Big5HKSCS::escape $var) {
...
$var = <<'END';
eval Char::Big5HKSCS::escape $var2
END
