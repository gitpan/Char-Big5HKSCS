...
${Ebig5hkscs::anchor}      = qr{\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?}oxms;
BEGIN { CORE::eval q{ use vars qw(
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:$tbcs_1st[^$sbcs]{2})*?}oxms;
    }

    ${Ebig5hkscs::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?|(?(?=[$sbcs]+\z).*?|(?:${Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
...
# ${Ebig5hkscs::eS}        = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20])};
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Big5HKSCS::re_t=%s; local $Big5HKSCS::re_a=''; while($Big5HKSCS::re_t =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s$Big5HKSCS::re_t="$Big5HKSCS::re_a${1}$Big5HKSCS::re_r$'"; pos($Big5HKSCS::re_t)=length "$Big5HKSCS::re_a${1}$Big5HKSCS::re_r"; $Big5HKSCS::re_a=substr($Big5HKSCS::re_t,0,pos($Big5HKSCS::re_t)); } return $Big5HKSCS::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Big5HKSCS::re_r=CORE::eval $Big5HKSCS::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Big5HKSCS::re_t=%s; while($Big5HKSCS::re_t =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s$Big5HKSCS::re_t="$`$Big5HKSCS::re_r$'"; pos($Big5HKSCS::re_t)=length "$`$Big5HKSCS::re_r"; } return $Big5HKSCS::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Big5HKSCS::re_r=%s; %s"%s$Big5HKSCS::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Big5HKSCS::re_n=0; local $Big5HKSCS::re_a=''; while(%s =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="$Big5HKSCS::re_a${1}$Big5HKSCS::re_r$'"; pos(%s)=length "$Big5HKSCS::re_a${1}$Big5HKSCS::re_r"; $Big5HKSCS::re_a=substr(%s,0,pos(%s)); $Big5HKSCS::re_n++} return %s$Big5HKSCS::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Big5HKSCS::re_n=0; while(%s =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="$`$Big5HKSCS::re_r$'"; pos(%s)=length "$`$Big5HKSCS::re_r"; $Big5HKSCS::re_n++} return %s$Big5HKSCS::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="%s$Big5HKSCS::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="%s$Big5HKSCS::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Big5HKSCS::re_r=CORE::eval $Big5HKSCS::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
