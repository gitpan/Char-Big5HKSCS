...
=item Make character
  ...
  set. For example, Ebig5hkscs::chr(65) is "A" in either ASCII or Big5-HKSCS, not Unicode,
  and Ebig5hkscs::chr(0x82a0) is a Big5-HKSCS HIRAGANA LETTER A. For the reverse of
  Ebig5hkscs::chr, use Big5HKSCS::ord.
