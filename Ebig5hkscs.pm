...
if (($] >= 5.010001) or
    ...
    if (__PACKAGE__ =~ / \b Egb18030 \z/oxms) {
        ${Ebig5hkscs::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[^\x30-\x39\x81-\xFE](?:[\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE]{2})*?}oxms;
    }
...
This module is a run-time routines of the Big5HKSCS.pm.
Because the Big5HKSCS.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Ebig5hkscs::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Ebig5hkscs::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Ebig5hkscs::fc function for case-insensitive comparisons via Big5HKSCS
  software.
...
=item Fold case string
  ...
  New to Big5HKSCS software, this function returns the full Unicode-like casefold of
...
=item File test function Ebig5hkscs::X
...
=item Filename expansion (globbing)
  ...
  The Ebig5hkscs::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Ebig5hkscs::stat, Ebig5hkscs::lstat, or Ebig5hkscs::stat-based file test function
