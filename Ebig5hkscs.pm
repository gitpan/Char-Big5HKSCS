...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Ebig5hkscs::binmode(FILEHANDLE, $disciplines);
  Ebig5hkscs::binmode(FILEHANDLE);
  Ebig5hkscs::binmode($filehandle, $disciplines);
  Ebig5hkscs::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Ebig5hkscs::open(FILEHANDLE, $mode, $expr);
  $rc = Ebig5hkscs::open(FILEHANDLE, $expr);
  $rc = Ebig5hkscs::open(FILEHANDLE);
  $rc = Ebig5hkscs::open(my $filehandle, $mode, $expr);
  $rc = Ebig5hkscs::open(my $filehandle, $expr);
  $rc = Ebig5hkscs::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Ebig5hkscs::open($fh, ">logfile")     # $fh is autovivified
  ...
  Ebig5hkscs::open my $fh, ">logfile" or die ...
  ...
  Ebig5hkscs::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Ebig5hkscs::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Ebig5hkscs::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Ebig5hkscs::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Ebig5hkscs::open(FH, "<:crlf:encoding(Big5HKSCS)", $path) or die "can't open $path: $!";
