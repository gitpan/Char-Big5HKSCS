...
=head1 SYNOPSIS
  ...
  use Big5HKSCS ver.sion qw(ord reverse);
  use Big5HKSCS ver.sion.0 qw(ord reverse);
...
Regular expression works as character-oriented that has no /b modifier.
  ...
  s/regexp/replacement/   eval{ Ebig5hkscs::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
 
  $_ !~                   ($_ !~ m/ditto$Ebig5hkscs::matched/) ?
  s/regexp/replacement/   1 :
                          eval{ Ebig5hkscs::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; undef }
...
Regular expression works as byte-oriented that has /b modifier.
  ...
  s/regexp/replacement/b  eval{ Ebig5hkscs::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
