...
# subroutines of package Ebig5hkscs
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc)    { $slash = 'm//'; return "Ebig5hkscs::$1(" . e_q ('',  $2,$4,$3) . ")"; }
...
# subroutines of package Ebig5hkscs
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc)    { $e_string .= "Ebig5hkscs::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
