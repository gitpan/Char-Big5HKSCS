...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Big5HKSCS software provides)

Big5HKSCS software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Big5HKSCS software provide)
...
=head1 Escaping File Test Operators (Big5HKSCS software provide)
