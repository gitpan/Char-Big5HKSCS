...
my $qq_substr  = qr{(?: Big5HKSCS::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
my $function_getc;        # getc    to getc    or Big5HKSCS::getc
...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    ...
                    $function_getc    = 'Big5HKSCS::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                        1                                              2   3                                 4   5
                q<eval{local $Big5HKSCS::re_t=%s; local $Big5HKSCS::re_a=''; while($Big5HKSCS::re_t =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s$Big5HKSCS::re_t="$Big5HKSCS::re_a${1}$Big5HKSCS::re_r$'"; pos($Big5HKSCS::re_t)=length "$Big5HKSCS::re_a${1}$Big5HKSCS::re_r"; $Big5HKSCS::re_a=substr($Big5HKSCS::re_t,0,pos($Big5HKSCS::re_t)); } return $Big5HKSCS::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Big5HKSCS::re_r=eval $Big5HKSCS::re_r; ' x $e_modifier,                  #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                        1                        2   3                                 4   5
                q<eval{local $Big5HKSCS::re_t=%s; while($Big5HKSCS::re_t =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s$Big5HKSCS::re_t="$`$Big5HKSCS::re_r$'"; pos($Big5HKSCS::re_t)=length "$`$Big5HKSCS::re_r"; } return $Big5HKSCS::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2          3                                 4   5  6                    7
                q<(%s =~ %s) ? eval{%s local $^W=0; local $Big5HKSCS::re_r=%s; %s"%s$Big5HKSCS::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<eval{local $Big5HKSCS::re_n=0; local $Big5HKSCS::re_a=''; while(%s =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="$Big5HKSCS::re_a${1}$Big5HKSCS::re_r$'"; pos(%s)=length "$Big5HKSCS::re_a${1}$Big5HKSCS::re_r"; $Big5HKSCS::re_a=substr(%s,0,pos(%s)); $Big5HKSCS::re_n++} return %s$Big5HKSCS::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                 1     2   3                                 4   5 6                         7                                                 8
                q<eval{local $Big5HKSCS::re_n=0; while(%s =~ %s){%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="$`$Big5HKSCS::re_r$'"; pos(%s)=length "$`$Big5HKSCS::re_r"; $Big5HKSCS::re_n++} return %s$Big5HKSCS::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3          4                                 5   6 7   8
                q<(%s%s%s) ? eval{%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="%s$Big5HKSCS::re_r$'"; 1 } : undef> :

                #  1 2 3              4                                 5   6 7   8
                q<(%s%s%s) ? 1 : eval{%s local $^W=0; local $Big5HKSCS::re_r=%s; %s%s="%s$Big5HKSCS::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Big5HKSCS::re_r=eval $Big5HKSCS::re_r; ' x $e_modifier,                  #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
expand wildcard arguments supplied to programs. Instead, import of Ebig5hkscs.pm
works well.
...
Definitions in Ebig5hkscs.pm.
  ...
  ${Ebig5hkscs::eS}             qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s])}
  ...
  ${Ebig5hkscs::not_space}      qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s\x0B])}
...
=item * Returns Next Character
  ...
  If you import getc "use Big5HKSCS qw(getc);", getc of your script will be rewritten in
  Big5HKSCS::getc. Big5HKSCS::getc is not compatible with getc of JPerl.
...
=item * Substr by Big5-HKSCS Character
  ...
  If Perl version 5.14 or later, you can use the Big5HKSCS::substr() function as an
...
=item * Filename Globbing
  ...
  This operator is implemented via the Ebig5hkscs::glob() function. See Ebig5hkscs::glob of
  Ebig5hkscs.pm for details.
