...
my $m_matched   = '';
my $s_matched   = '';
$m_matched   = q{@Ebig5hkscs::m_matched};
...
functions.
  ...
  index       Ebig5hkscs::index
  rindex      Ebig5hkscs::rindex
  lc          Ebig5hkscs::lc
  lcfirst     Ebig5hkscs::lcfirst
  uc          Ebig5hkscs::uc
  ucfirst     Ebig5hkscs::ucfirst
  chr         Ebig5hkscs::chr
  glob        Ebig5hkscs::glob
  lstat       Ebig5hkscs::lstat
  opendir     Ebig5hkscs::opendir
  stat        Ebig5hkscs::stat
  unlink      Ebig5hkscs::unlink
  chdir       Ebig5hkscs::chdir
  do          Ebig5hkscs::do
  require     Ebig5hkscs::require
  ---------------------------------
...
=item * Reverse List Or String
  ...
  %barfoo = Big5HKSCS::reverse(%foobar);
...
=item * Special Variables $` And $& Doesn't Function
  ...
  is escaped to
    'AAABBBCCC' =~ /\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?(?:BBB)@Ebig5hkscs::m_matched/;
