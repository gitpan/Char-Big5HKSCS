...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Ebig5hkscs::uc($char[$i]) ne Ebig5hkscs::lc($char[$i]))) {
...
=item * Only Big5HKSCS.pm and Ebig5hkscs.pm, other modules are unnecessary
...
Big5HKSCS.pm remove 'bytes::' at head of function name.
...
oriented function. See 'CHARACTER ORIENTED FUNCTIONS'.
  ...
  index       Big5HKSCS::index
  rindex      Big5HKSCS::rindex
  ---------------------------------
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Ebig5hkscs.pm
  --------------------------------------------------------------------
  binmode(...);   Ebig5hkscs::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Ebig5hkscs::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Big5HKSCS software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Big5HKSCS software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Big5HKSCS)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Ebig5hkscs.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Ebig5hkscs.pm provides bytes::*
